...
to setup
 ...
 ;; set Network 0
  ...
  [
    sprout 1
      [ set breed cars set color white set shape "car" set speed .8
  ...
  set speed-limit max_speed_bikes set speed-min .05 set energy random 100 set VRUdensity 0 set color black set shape "person" set heading random 360 set crashed 0 ]
  ]
...
;;  if not any? bicycles-on patch-here [ set collisionsbikes 0 set shape "car" ]
;;end
